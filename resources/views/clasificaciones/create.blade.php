...
<div class="col-md-10 col-md-offset-1">
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('clasificaciones.index') }}">Clasificación</a></li>
        <li class="active">Crear</li>
    </ol>
    <div class="page-header text-center">
        <h2>Crear clasificación<small>.</small></h2>
    </div>
    ...
    <div class="col-xs-8 col-xs-offset-2">
        ...
        {!! Form::open(['class' => 'form-horizontal responsive', 'url' => 'clasificaciones']) !!}
