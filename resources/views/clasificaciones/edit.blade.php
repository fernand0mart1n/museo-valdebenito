...
<div class="col-md-10 col-md-offset-1">
    ...
    <div class="page-header text-center">
        <h2>Modificar clasificación<small>.</small></h2>
    </div>
    ...
    <div class="col-xs-8 col-xs-offset-2">
        ...
        {!! Form::model($clasificacion,['method' => 'PATCH', 'class' => 'form-horizontal responsive', 'route'=>['clasificaciones.update',$clasificacion->id]]) !!}
        <div class="form-group">
            {!! Form::label('fondo_id', 'Fondo:', array('class' => 'control-label col-xs-4')) !!}
            <div class='col-xs-8'>
                {!! Form::text('fondo_id', null, ['class'=>'form-control',  'placeholder' => 'Fondo', 'required' => 'true']) !!}
            </div>
        </div>
        <div class="form-group">
            {!! Form::label('usuario_id_carga', 'Usuario:', array('class' => 'control-label col-xs-4')) !!}
            <div class='col-xs-8'>
                {!! Form::text('usuario_id_carga', null, ['class'=>'form-control',  'placeholder' => 'Usuario', 'required' => 'true']) !!}
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class='col-xs-8'>
                {!! Form::textarea('descripcion', null,['class'=>'form-control', 'placeholder' => 'Descripción', 'pattern' => '([0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])|^(?:(?:31(\/|-|\.)(?:0?[13578]|1[02]))\1|(?:(?:29|30)(\/|-|\.)(?:0?[1,3-9]|1[0-2])\2))(?:(?:1[6-9]|[2-9]\d)?\d{2})$|^(?:29(\/|-|\.)0?2\3(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\d|2[0-8])(\/|-|\.)(?:(?:0?[1-9])|(?:1[0-2]))\4(?:(?:1[6-9]|[2-9]\d)?\d{2})$)', 'title' => 'Descripción', 'required' => 'true', 'rows' => '5']) !!}
            </div>
        </div>
        <div class="form-group">
