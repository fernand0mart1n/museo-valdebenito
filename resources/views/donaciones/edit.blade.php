...
<div class="col-md-10 col-md-offset-1">
    ...
    <div class="page-header text-center">
        <h2>Editar datos de donación<small>.</small></h2>
    </div>
    ...
    <div class="col-xs-8 col-xs-offset-2">
        ...
        {!! Form::model($donacion,['method' => 'PATCH', 'class' => 'form-horizontal responsive', 'route'=>['donaciones.update',$donacion->id]]) !!}
